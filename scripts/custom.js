...
//            var share_title = document.title;
        ...
        function activate_pageGreeting(){
            ...
            var greetingMorning = ('Buenos dias');
            var greetingAfternoon = ('Buenas tardes');
            var greetingEvening = ('Buena noches');
    ...
    if(isPWA === true){
        ...
        //     $('head').append('<link rel="manifest" id="manifest-pwa" href="manifest.json" data-pwa-version="set_by_pwa.js">')
        // }
        var loadJS = function(url, implementationCode, location){
            var scriptTag = document.createElement('script');
            scriptTag.src = url;
